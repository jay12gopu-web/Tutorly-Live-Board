...
export function TopBar({ canUndo, canRedo, onUndo, onRedo, onClear, onExit, studentWorkMode, onMyWork, onReturnToLesson }: TopBarProps) {
  return (
    <header className="topbar" aria-label="Tutorly Live Board header">
      ...
      <div className="topbar-context">
        <span className="eyebrow">{studentWorkMode ? 'StudentLayer' : 'Live lesson'}</span>
